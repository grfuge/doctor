...
gulp.task('uglify', function() {
  return gulp.src('src/js/*.js')
    ...
    .pipe(gulp.dest('public/wp-content/themes/doctor/js'));
});
...
gulp.task('minify', function() {
  return gulp.src('public/wp-content/themes/doctor/**/*.php')
    .pipe(htmlmin({collapseWhitespace: true}))
    .pipe(gulp.dest('public/wp-content/themes/doctor'));
});
...
gulp.task('minify-css', () => {
  return gulp.src('public/wp-content/themes/doctor/css/*.css')
    .pipe(cleanCSS({level: 2}))
    .pipe(gulp.dest('public/wp-content/themes/doctor/css'))
    .pipe(browserSync.stream({match: '**/*.css'}));
});

gulp.task('clean', function () {
  del('public/wp-content/themes/doctor/sass');
  del('public/wp-content/themes/doctor/css/**/*.scss');
  del('public/wp-content/themes/doctor/img/src');
  return;
});
...
gulp.task('dir-sync', function() {
  return gulp.src( '' )
    .pipe(dirSync( 'src', 'public/wp-content/themes/doctor', { printSummary: true } ));
});
